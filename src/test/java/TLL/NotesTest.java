...
public class NotesTest {
    ...
    public void studentNoteTest(){
        ...
        Notes notes = new Notes(tokens);
        notes.noteTrading(learner2.getFirstName());
        notes.noteTrading(learner3.getFirstName());

        assertEquals("{Alice=1, Richard=3, Busisile=1, Andre=3, Paul=3}",tokens.studentsTokenTotalMap().toString());
    }
}
